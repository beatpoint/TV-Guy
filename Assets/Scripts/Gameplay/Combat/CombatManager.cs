...
//using TVGuy.Gameplay.Characters.Enemies;
using TVGuy.Gameplay.Combat.StatusAilment;
//using TVGuy.Gameplay.Combat.UI;
//using TVGuy.Gameplay.Systems;
...
namespace TVGuy.Gameplay.Combat
{
    ...
    public class CombatManager : MonoBehaviour, ICombatManager/*, IGameplaySystemModule, IGameplayInitializable*/
    {
        [SerializeField]
